...
<form action="http://de.buyme.vn:8080/index.php/users/login" method="post" accept-charset="utf-8" id="login-small">
...
<input type="submit" value="Login" name="btnLogin" /> or &nbsp;<a href="http://de.buyme.vn:8080/index.php/register">Signup</a> <input type="checkbox" id="remember-checksidebar" name="remember" value="1"  /><span>Remember Me</span>
</li>
...
<!-- Begin nav -->
<ul id="head-nav">
<li><a href="http://de.buyme.vn:8080/index.php" target="">Home</a></li>
